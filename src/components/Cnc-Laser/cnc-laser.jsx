...
import RouterImage from "../../assets/Interiar/Router1.jpg";
import RouterImage1 from "../../assets/Interiar/Router2.jpg";
import LaserImage from "../../assets/Interiar/Laser1.jpg";
import LaserImage1 from "../../assets/Interiar/Laser2.jpg";
                            ...
                            >
                                <div class="row">
                                    <div class="col-lg-12 col-md-6 ">
                                        <div class="inner-box">
                                            <h4 class="text-start">CNC Routing :</h4>
                                        </div>
                                    </div>
                                    <div className="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            >
                                <div class="row">
                                    <div class="col-lg-12 col-md-6 ">
                                        <div class="inner-box">
                                            <h4 class="text-start">Laser Cutting :</h4>
                                        </div>
                                    </div>
                                    <div className="row">
                                        <div class="col-lg-3 mt-3 col-md-3 col-3">
